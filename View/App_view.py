...
class App(Tk):
    ...
    def __init__(self):
        ...
        self.notebook = ttk.Notebook(self, width=650, height=650)
        vocabulary_frame = Frame(self.notebook, bd=4, padx=20, pady=10, bg='yellow')
        obj_prop_frame = Frame(self.notebook, bd=4, padx=20, pady=10, bg='blue')
        subj_pred_obj_frame = Frame(self.notebook, bd=4, padx=20, pady=10, bg='gray')
        individuals_tree_frame = Frame(self.notebook, bd=4, padx=20, pady=10, bg='#cc0099')
