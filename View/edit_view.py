...
class Edit(tk.Toplevel):
    ...
    def __init__(self, parent, graph):
        ...
        self.name_text = ttk.Combobox(self.edit_frame, values=class_hints, width=25)
        ...
        self.parent_change_entry = ttk.Combobox(self.edit_class_frame, values=class_hints, width=30)
        ...
        self.subject_entry = ttk.Combobox(self.edit_objprop_frame, values=subject_hints, width=30)
        who_is_object_label = Label(self.edit_objprop_frame, text="Object")
        self.object_entry = ttk.Combobox(self.edit_objprop_frame, values=object_hints, width=30)
        ...
        self.parent_entry = ttk.Combobox(self.edit_individual_frame, values=hint_individuals, width=30)
